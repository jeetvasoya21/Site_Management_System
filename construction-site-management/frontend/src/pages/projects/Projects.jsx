      ...
      render: (value, row) => (
        <div className="flex gap-2">
          <button
            ...
            className="p-1 text-blue-500 hover:bg-slate-800/40 rounded transition-colors"
            title="Edit"
          >
            <Edit2 size={16} />
          </button>
          <button
            ...
            className="p-1 text-rose-500 hover:bg-slate-800/40 rounded transition-colors"
            title="Delete"
          >
            <Trash2 size={16} />
          </button>
