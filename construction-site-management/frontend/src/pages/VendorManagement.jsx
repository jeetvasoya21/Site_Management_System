    ...
    },
    {
      ...
      render: (value) => (
        <div>
          ...
          <p className="text-slate-400 text-xs">Spent: {formatCurrency(vendorSpending[value] || 0)}</p>
        </div>
      ),
    },
    {
      ...
      render: (_, row) => (
        <div className="flex gap-2">
          <button
            className="p-1 text-blue-500 hover:bg-slate-800/40 rounded"
            onClick={() => {
              setEditing(row);
              setForm({
          ...
          <button
            className="p-1 text-rose-500 hover:bg-slate-800/40 rounded"
            onClick={() => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-slate-100">Vendor Management</h1>
