  ...
  if (!worker || !salary) {
    return (
      <div className="space-y-6">
        <h1 className="text-3xl font-bold text-slate-100">My Salary</h1>
    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-wrap gap-4 items-end">
          <div>
            ...
            <select
              ...
              className="px-3 py-2 bg-slate-800/40 border border-slate-800 rounded-lg text-slate-100 focus:border-amber-500 focus:outline-none"
            >
              {months.map((m, i) => (
      ...
      <Card className="bg-amber-500/10 border-amber-500/50">
        <div className="flex items-center justify-between p-2">
          ...
          <IndianRupee size={48} className="text-amber-500/30" />
        </div>
      </Card>
              ...
              <tbody>
                {monthRecords.map((entry) => (
                  <tr key={entry.id} className="border-b border-slate-800">
                    <td className="py-3 px-4 text-slate-100 text-sm">{entry.date}</td>
                    ...
                    <td className="py-3 px-4 text-slate-100 text-sm font-medium">
